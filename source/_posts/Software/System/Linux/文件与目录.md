...
```shell
rmdir test1 #删除目录
rmdir -p test2/test3/test4 #删除多级目录
```
...
![image-20200729223243490](https://cdn.jsdelivr.net/gh/LuShan123888/Files@master/Pictures/2020-12-10-vZfXuBbAkPIRg2J.png)
