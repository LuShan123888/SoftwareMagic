...
```bash
docker run  -d --name redis6.0.8 -p 6379:6379 -v /Users/cian/DockerVolumes/redis6.0.8/conf:/etc/redis -v ~/DockerVolumes/redis6.0.8/data:/data redis:6.0.8 redis-server /etc/redis/redis.conf
```
